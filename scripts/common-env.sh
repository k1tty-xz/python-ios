...
PACKAGE_REVISION="${PACKAGE_REVISION:-6}"
...
MPDECIMAL_SHA256="${MPDECIMAL_SHA256:-96d33abb4bb0070c7be0fed4246cd38416188325f820468214471938545b1ac8}"
...
MPDECIMAL_PREFIX="$DEPS/mpdecimal-ios/usr/local"
MPDECIMAL_CFLAGS="-I${MPDECIMAL_PREFIX}/include"
MPDECIMAL_LIBS="-L${MPDECIMAL_PREFIX}/lib -lmpdec"

export PY_VER LIBFFI_VER MPDECIMAL_VER OPENSSL_VER PACKAGE_REVISION MIN_IOS IOS_SDK_VERSION
